...
<head>
    ...
    <title>Delete Account | BPL</title>
...
if (! empty($_SESSION['user']))
{
    ...
    ?>
								  <li class="dropdown">
									  <a href="#" class="active" class="dropdown-toggle" data-toggle="dropdown" >ACCOUNT<b class="caret"></b></a>
                                        <ul class="dropdown-menu">
                                            <li>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ul class="breadcrumb pull-right">
                       <li><a href="HOME.php">Home</a></li>
						<li><a href="usercrud.php">Account</a></li>
...
<br></br><br></br>
  ...
  <table style="width:100%" class="table table-sm table-inverse">

       <tr bgcolor="#41D45D">
     <td align="center" style="color:black">Name</td>
	 <td align="center" style="color:black">Email</td>
	 <td align="center" style="color:black">Password</td>
	 <td align="center" style="color:black">Favorite Team</td>
 ...
 <?php
	require 'connect.php';
	$sql="SELECT * FROM users  WHERE user_name='".$u."' LIMIT 1";
	$res=mysql_query($sql);
	...
	while($data = mysql_fetch_array($myData1)){
		...
		echo '<td style="text-align:center;color:black">' . $data['user_name'] . "</td>";
		echo '<td style="text-align:center;color:black">' . $data['email'] . "</td>";	
	    echo '<td style="text-align:center;color:black">' . $data['password'] . "</td>";	
		echo '<td style="text-align:center;color:black">' . $data['fav_team'] . "</td>";	
		echo "<td>" . "<input type=hidden name=hidden value='" . $data['user_id'] . "' </td>";
		echo "<td >" . "<input type=submit style=background:#41D45D style=width:100% name=userdelete value=delete" . " </td>";
		echo "</tr>";
		echo "</form>";
	};		
	}
