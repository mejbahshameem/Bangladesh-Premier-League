...
<head>
    ...
    <title>Update Account | BPL</title>
...
<br></br><br></br>
 ...
 <?php
	...
	while($data1 = mysql_fetch_array($myData1)){
		...
		echo "<tr>";
		echo "<td>" . "<input type=text name=username value='" . $data1['user_name'] . "' </td>";
		echo "<td>" . "<input type=text name=email value='" . $data1['email'] . "' </td>";
	    echo "<td>" . "<input type=text name=password value='" . $data1['password'] . "' </td>";		
		echo "<td>" . "<input type=text style=width:126px name=fav_team value='" . $data1['fav_team'] . "' </td>";	
		echo "<td>" . "<input type=hidden name=hidden value='" . $data1['user_id'] . "' </td>";
		echo "<td >" . "<input type=submit style=background:#41D45D name=userupdate value=update" . " </td>";
		echo "</tr>";
		echo "</form>";
	};
	}
