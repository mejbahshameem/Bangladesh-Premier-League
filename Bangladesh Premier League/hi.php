            ...
            <div class="carousel-inner">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="carousel-content center centered">
                                    <h2 class="boxed animation animated-item-1">"Bangladesh might have found another left-arm bowler"</h2>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="carousel-content centered">
                                    <h2 class="animation animated-item-1">Dhaka Dynamites won tonight</h2>
                                    <p class="animation animated-item-2">DHAKA 112/4 (19.2 Ovs) COMILLA 110/8 (20.0 Ovs)</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="item" style="background-image: url(images/slider/bg3.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content centered">
									<h2 class="animation animated-item-1">BANGLADESH PREMIER LEAGUE</h2>
                                    <p class="animation animated-item-2">Highest professional cricket league in Bangladesh.</p>
				...
				<div class="item" style="background-image: url(images/slider/bg1.jpg)" >
					<video width="100%" height="100%" controls>
						<source src="images/slider/MM.mp4" type="video/mp4">             
					</video>
				</div><!--/.item-->
            </div><!--/.carousel-inner-->
        </div><!--/.carousel-->
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h3 class="media-heading"><a target="_blank" href="http://www.facebook.com">Facebook</a></h3>
                            <p>Facebook Follow</p>
                        </div>
                    </div>
                </div><!--/.col-md-4-->
                                    ...
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                ...
                                                <h5>
                                                    <a href="bpl16.html">BPL T20 2016 Opening Ceremony</a>
                                                </h5>
                                    ...
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                ...
                                                <h5>
                                                    <a href="bb9.html">Barisal vs Rangpur Riders match Preview</a>
                                                </h5>
                                    ...
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                ...
                                                <h5>
                                                    <a href="dd9.html">Ananta Jalil Has Been Announced As The Brand Ambassador of Comilla Victorians</a>
                                                </h5>
                                    ...
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                ...
                                                <h5>
                                                    <a href="Bpl-4.html">Bpl 4 will be held in november 2016</a>
                                                </h5>
                                    ...
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                ...
                                                <h5>
                                                    <a href="ch9.html">BPL Live Telecast in Channel 9</a>
                                                </h5>
                                            </div>
                                        </div>
                                    </div>                            
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                ...
                                                <h5>
                                                    <a href="rr9.html">Chittagong Vikings vs Rangpur Riders match Preview</a>
                                                </h5>
...
?>
...
</div></div><div class="col-md-3 columns"><div class="simple-column"><script type="text/javascript">
	jQuery(document).ready(function($){
		...
		<div class="kd-counter">
			<i class="fa-3x fa fa fa-users fa-3x"></i>
			<span id="count-2" class="word-count">314</span>
			<small>Howzat</small>
		</div>
</div></div><div class="col-md-3 columns"><div class="simple-column"><script type="text/javascript">
	jQuery(document).ready(function($){
		...
		<div class="kd-counter">
			<i class="fa-3x fa fa fa-flag fa-3x"></i>
			<span id="count-3" class="word-count">258</span>
			<small>Sixes </small>
		</div>
</div></div><div class="col-md-3 columns"><div class="clear"></div><div class="kode-item kode-divider-item"><div class="kode-divider"></div></div><div class="simple-column"><script type="text/javascript">
	jQuery(document).ready(function($){
		/* ---------------------------------------------------------------------- */
		/*	Counter Functions
		/* ---------------------------------------------------------------------- */
		...
		<div class="kd-counter">
			<i class="fa-3x fa fa fa-trophy fa-3x"></i>
			<span id="count-4" class="word-count">552</span>
			<small>Fours</small>
		</div>
