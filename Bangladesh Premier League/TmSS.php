...
<head>
    ...
    <title>Sylhet Superstars | BPL</title>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active";class="dropdown">
                        ...
                        <ul class="dropdown-menu">
							...
							<li class="active"><a href="TmSS.php">Sylhet Superstars </a></li>
...
<?php
	require 'connect.php';
	$sql="SELECT * FROM `players` WHERE team='Sylhet Superstars'";
