                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active";class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="TmBB.php">Barisal Bulls</a></li>
...
<?php
	require 'connect.php';
	$sql="SELECT * FROM `players` WHERE team='Barisal Bulls'";
