...
<head>
    ...
    <title>Chittagong Vikings | BPL</title>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active";class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="TmChV.php">Chittagong Vikings</a></li>
...
<?php
	require 'connect.php';
	$sql="SELECT * FROM `players` WHERE team='Chittagong Vikings'";
