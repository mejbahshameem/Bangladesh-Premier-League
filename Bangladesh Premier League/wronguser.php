...
<head>
    ...
    <title>Invalid Log in| BPL</title>
...
<br></br><br></br>
    <section id="registration" class="container">
        ...
        <form class="center" role="form" action="useraction.php" method="post">
			...
			<p style="color:red">** Incorrect User Name or Password</p>
                ...
                <div class="form-group">
                    <input type="submit" name="loginuser" class="btn btn-success btn-md btn-block" value="Log In"/>
                </div>
				New to BPL?<a href="registration_user.php"><font color="red"> Sign Up Here</font></a>
            </fieldset>
        </form>
