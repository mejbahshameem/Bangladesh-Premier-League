        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <p class="lead section-lead">Select the Class</p>
                    ...
                    <form class="form-horizontal">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                          <input type="text" class="form-control" id="inputSubject3" placeholder="Class Name">
                        </div>
                      </div>

                      <div class="form-group">
                        <div class="col-md-offset-4 col-md-7">
                          <button type="submit" class="btn btn-default"><a href="admin_add_subjects.php">Add Subjects</a></button>
                        </div>
                      </div>
                    </form>
                </div>
