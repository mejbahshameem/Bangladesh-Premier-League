        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h1 class="section-heading">Add Student</h1>
                    <p class="lead section-lead">Please provide student's information</p>
                    ...
                    <form class="form-horizontal">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                          <input type="text" class="form-control" id="inputSubject3" placeholder="Name">
                        </div>
                      </div>

                      <div class="form-group">
                        <label for="inputSubject3" class="col-md-4 control-label">Roll</label>
                        <div class="col-md-4">
                          <input type="text" class="form-control" id="inputSubject3" placeholder="Roll">
                        </div>
                      </div>

                      <div class="form-group">
                        <label for="inputSubject3" class="col-md-4 control-label">Contact</label>
                        <div class="col-md-4">
                          <input type="text" class="form-control" id="inputSubject3" placeholder="Contact">
                        </div>
                      </div>

                      <div class="form-group">
                        <label for="inputSubject3" class="col-md-4 control-label">Class</label>
                        <div class="col-md-4">
                          <input type="text" class="form-control" id="inputSubject3" placeholder="Class">
                        </div>
                      </div>
