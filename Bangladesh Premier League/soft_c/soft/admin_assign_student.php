        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h1 class="section-heading">Assign Student</h1>
                    <p class="lead section-lead">Please select subject and student</p>

                    <form action="AssignStudent.php" method="POST" class="form-horizontal">

                      
                      <div class="form-group">
                        <label for="inputSubject3" class="col-md-4 control-label">Subject Name</label>
                        <div class="col-md-4">
                          <input type="text" class="form-control" id="sbjn" name="sbjn" placeholder="Subject Name">
                        </div>
                      </div>

                      <div class="form-group">
                        <label for="inputSubject3" class="col-md-4 control-label">Student Name</label>
                        <div class="col-md-4">
                          <input type="text" class="form-control" id="stdn" name="stdn" placeholder="Student Name">
                        </div>
                      </div>
