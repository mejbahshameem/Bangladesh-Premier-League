        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h1 class="section-heading">Select Class</h1>
                    <p class="lead section-lead">Please select the class</p>

                    <form action="admin_add_subjects_post.php" class="form-horizontal">
