        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h1 class="section-heading">Add Subjects</h1>
                    <p class="lead section-lead">Please Add subjects for the Class 6</p>

                    <form class="form-horizontal">

                      <div class="form-group">
                        <label for="inputSubject3" class="col-md-4 control-label">Subject 1</label>
                        <div class="col-md-4">
                          <input type="text" class="form-control" id="inputSubject3" placeholder="Subject Name">
                        </div>
                      </div>

                      <div class="form-group">
                        <label for="inputSubject3" class="col-md-4 control-label">Subject 2</label>
                        <div class="col-md-4">
                          <input type="text" class="form-control" id="inputSubject3" placeholder="Subject Name">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label for="inputSubject3" class="col-md-4 control-label">Subject 3</label>
                        <div class="col-md-4">
                          <input type="text" class="form-control" id="inputSubject3" placeholder="Subject Name">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-offset-4 col-md-7">
                          <button type="submit" class="btn btn-default">Add Subjects</button>
                        </div>
                      </div>
                    </form>
