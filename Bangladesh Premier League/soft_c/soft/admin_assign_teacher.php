...
<?php
    ...
    $link = new mysqli($servername,'root','','sis');
    if($link->connect_error){die("<h2>Connection Failed!!<h2>".$this->link->connect_error);}
    $try = '';
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h1 class="section-heading">Assign Teacher</h1>
                    <p class="lead section-lead">Please select class, subject and teacher</p>

                   

				   <form action="AssignTeacher.php" method="POST" class="form-horizontal">

                      <div class="form-group">
                        <label for="inputSubject3" class="col-md-4 control-label">Class Name</label>
                        <div class="col-md-4">
                          <input type="text" class="form-control" id="cn" name="cn" placeholder="Class Name">
                        </div>
                      </div>

                      <div class="form-group">
                        <label for="inputSubject3" class="col-md-4 control-label">Subject Name</label>
                        <div class="col-md-4">
                          <input type="text" class="form-control" id="sn" name="sn" placeholder="Subject Name">
                        </div>
                      </div>

                      <div class="form-group">
                        <label for="inputSubject3" class="col-md-4 control-label">Teacher Name</label>
                        <div class="col-md-4">
                          <input type="text" class="form-control" id="tn" name="tn" placeholder="Teacher Name">
                        </div>
                      </div>
