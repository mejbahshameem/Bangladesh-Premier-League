                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">MORE <i class="icon-angle-down"></i></a>
							<ul class="dropdown-menu">
								...
								<li class="active"><a href="vision.php">BPL Vision</a></li>
...
else
{
 ...
 ?>  
    ...
    <section id="terms" class="container">
        ...
        <p>Find out the new and talented player around the country</p>

        <p>&nbsp;</p>

        <h3>Help Local Player</h3>
        <p>Because of BPL local player can play with other international player. Local player can learn a lot from them</p>
