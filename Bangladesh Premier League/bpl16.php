...
<body>
    ...
    <header class="navbar navbar-inverse navbar-fixed-top wet-asphalt" role="banner">
        <div class="container">
			...
			<h3 style="color:yellow">BANGLADESH PREMIER LEAGUE</h3>
        ...
        <div class="row">
            <aside class="col-sm-4 col-sm-push-8">
                ...
                <div class="widget facebook-fanpage">
                     <h3><a href="https://www.facebook.com">Facebook Fanpage</a></h3>
            ...
            <div class="col-sm-8 col-sm-pull-4">
                <div class="blog">
                    ...
                    <div class="blog-item">
                        <img class="img-responsive img-blog" src="images/bpl16.gif" width="100%" alt="" />
                        <div class="blog-content">
                            <h3>BPL T20 2016 Opening Ceremony</h3>
