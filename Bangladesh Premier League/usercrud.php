...
<br></br><br></br>
    ...
    <section id="registration" class="container">
		...
		<a href="userinfo.php" <button type="button" class="btn btn-primary btn-block" style="background:#41D45D"></button> Your Info </a>
		 <br><br>
		<a href="userupdate.php" <button type="button" class="btn btn-primary btn-block" style="background:#41D45D"></button> Update Account Information</a>
		 <br><br>
		<a href="userdelete.php" <button type="button" class="btn btn-primary btn-block" style="background:#41D45D"></button> Delete Account</a>
		<br><br><br><br><br><br>
