...
<head>
    ...
    <title>Rangpur Riders | BPL</title>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active";class="dropdown">
                        ...
                        <ul class="dropdown-menu">
							...
							<li class="active"><a href="TmRR.php">Rangpur Riders</a></li>
                        </ul>
                    </li>										 					
                    <li class="dropdown">
...
<?php
	require 'connect.php';
	$sql="SELECT * FROM `players` WHERE team='Rangpur Riders'";
