 ...
 ?>  
    ...
    <section id="title" class="emerald">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <h1 style="color:white"><b>Photos</b></h1>
    ...
    <section id="portfolio" class="container">
        <ul class="portfolio-filter">
            ...
            <li><a class="btn btn-default" href="#" data-filter=".match">Match</a></li>
        ...
        <ul class="portfolio-items col-3">
            ...
            <li class="portfolio-item joomla match">
            ...
            <li class="portfolio-item joomla others">
                <div class="item-inner">
