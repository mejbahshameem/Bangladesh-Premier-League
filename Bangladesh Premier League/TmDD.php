...
<head>
    ...
    <title>Dhaka Dynamites | BPL</title>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active";class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="active"><a href="TmDD.php">Dhaka Dynamites</a></li>
...
<?php
	require 'connect.php';
	$sql="SELECT * FROM `players` WHERE team='Dhaka Dynamites'";
