...
<br></br><br></br>
  ...
  <table style="width:100%" class="table table-sm table-inverse">
       ...
       <tr bgcolor="#41D45D">
     <td align="center" bgcolor="#41D45D">Name</td>
...
{  
	...
	if(mysql_num_rows($res) == 1) {
		...
		echo "<tr>";
		echo '<td style="text-align:center;">' . $data['user_name'] . "</td>";
		echo '<td style="text-align:center;">' . $data['email'] . "</td>";
		echo '<td style="text-align:center;">' . $data['password'] . "</td>";
		echo '<td style="text-align:center;">' . $data['fav_team'] . "</td>";
		echo "</tr>";
	}
	}
